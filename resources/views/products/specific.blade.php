...
@section('content')
    <div class="container">
        <div class="container-fluid">
            ...
            <div class="row m-5">
                <div class="col">
                    <a href="{{route('products.create')}}" class="btn btn-success mt-auto">Add</a>
                </div>
            </div>
                @endauth
        <div class="row">
            @foreach($categories  as $category)
                <div class="col-4">
                    <a href="/products/{{$category->id}}" style="text-decoration: none">
                        ...
                        <div class="card-body">
                            ...
                            <p style=" text-align: center">{{$category->price}} جنيه </p>
